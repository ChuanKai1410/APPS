...
EMAIL_HOST = config('EMAIL_HOST', default='localhost')  # Email server host
EMAIL_PORT = 1025          # Email server port
EMAIL_USE_TLS = True      # Enable TLS for email
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='')  # Email host user
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='')       # Email host password
RECIPIENT_ADDRESS = config('RECIPIENT_ADDRESS', default='') # Recipient email address
